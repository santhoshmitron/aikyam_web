...
export default function TempleProfileLoading() {
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-gradient-to-b from-[#fdfbff] via-white to-amber-50/40 pb-24">
      <div className="relative h-[min(52vh,420px)] w-full overflow-hidden bg-gradient-to-br from-purple-950 via-purple-900 to-amber-900/30">
        <div className="absolute inset-0 animate-pulse bg-gradient-to-t from-[#1a0b2e]/90 to-transparent" />
      </div>

      <div className="relative mx-auto -mt-24 w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-[2rem] border border-white/50 bg-white/70 p-6 shadow-xl backdrop-blur-xl md:p-8">
      ...
      <div className="mx-auto mt-10 grid max-w-6xl gap-8 px-4 pb-16 sm:px-6 lg:grid-cols-3 lg:gap-10 lg:px-8">
