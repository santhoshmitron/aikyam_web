...
export function HistoryCard({ historyText }: Props) {
  ...
  return (
    <motion.article
      ...
      whileHover={{ y: -2 }}
      className="relative overflow-hidden rounded-[1.75rem] border border-purple-200/60 bg-gradient-to-br from-white via-purple-50/40 to-amber-50/30 p-6 shadow-[0_16px_48px_-20px_rgba(76,29,149,0.2)] md:p-8"
    >
      ...
      {historyText ? (
        <>
          <blockquote className="relative mt-4 border-l-[3px] border-amber-400/90 pl-5">
            <p className="whitespace-pre-line text-pretty text-[15px] leading-[1.75] text-purple-900/90 md:text-base">
              {shown}
            </p>
          </blockquote>
          {long ? (
            <button
              ...
              className="mt-4 text-sm font-semibold text-purple-700 underline-offset-4 hover:text-purple-900 hover:underline"
            >
