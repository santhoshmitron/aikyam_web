...
export function EstablishmentCard({ establishment }: Props) {
  ...
  return (
    <motion.article
      ...
      whileHover={{ y: -2 }}
      className="relative overflow-hidden rounded-[1.75rem] border border-amber-200/70 bg-gradient-to-br from-amber-50/90 via-white to-purple-50/50 p-6 shadow-[0_16px_48px_-20px_rgba(180,83,9,0.15)] md:p-8"
    >
      <div className="absolute bottom-0 left-6 top-8 w-0.5 rounded-full bg-gradient-to-b from-amber-400 via-purple-400 to-transparent" />
      <div className="pl-8">
        <SectionTitle icon={Landmark} title="Establishment" subtitle="Roots of devotion" />
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          {establishment.year ? (
            <div className="rounded-2xl bg-white/80 px-4 py-3 ring-1 ring-amber-200/60 backdrop-blur-sm">
          ...
          {establishment.foundedBy ? (
            <div className="rounded-2xl bg-white/80 px-4 py-3 ring-1 ring-purple-200/60 backdrop-blur-sm">
