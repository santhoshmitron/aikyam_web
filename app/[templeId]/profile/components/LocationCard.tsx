  ...
  if (!hasLocation) {
    return (
      <motion.article
        ...
        viewport={{ once: true }}
        className="rounded-[1.75rem] border border-dashed border-purple-300/60 bg-purple-50/40 p-6 text-center text-sm text-purple-800/75 md:p-8"
      >
  ...
  return (
    ...
    >
      ...
      <div className="mt-5 flex flex-col gap-3 sm:flex-row">
        <Button
          asChild
          className="flex-1 rounded-full bg-gradient-to-r from-purple-700 to-purple-900 text-white shadow-lg shadow-purple-900/20"
        >
        ...
        <Button
          asChild
          variant="outline"
          className="flex-1 rounded-full border-amber-400/70 bg-white/90 text-purple-900"
        >
